  ...
  return (
    <LayoutWrapper>
      <div className={'sm:w-5/6 xl:w-4/6 flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 px-3'}>
        ...
        <p className={'sm:h-64 text-slate-50 font-sans font-normal sm:text-justify text-xl sm:text-base md:text-xl m-0 pl-2 relative sm:before:hidden before:border-l-2 before:absolute before:h-full before:left-0'}>
